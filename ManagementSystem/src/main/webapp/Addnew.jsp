...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form" action="UserController" enctype="multipart/form-data" name="frmAddUser" method="post" >
				<input type="hidden" name="action" value="insert" />
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="UserController?action=listUser"> View-All-Records </a>
					</div>
					</form>
			</div>
		</div>
